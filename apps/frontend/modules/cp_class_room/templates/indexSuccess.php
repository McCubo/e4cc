<div id="div_container">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Class Rooms List</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>

    <ol class="breadcrumb">
        <li class="active">Class Rooms List</li>
    </ol>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#btn_new").click(function () {
                loadContent("div_container", "<?php echo url_for("cp_class_room/new"); ?>");
            });

            //functions
            function showInactive() {
                $.ajax({
                    url: "<?php echo url_for("cp_class_room/getList"); ?>",
                    type: "POST",
                    dataType: "HTML",
                    data: {
                        is_active: is_active
