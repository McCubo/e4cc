<table class="table table-bordered table-hover table-striped" id="table_list_<?php echo $type; ?>">
    <thead>
        <tr>
            <th>N°</th>
            <th>SITE</th>
    ...
    <tbody>
        ...
        foreach ($list as $record) {
            ...
            echo "<td><a href='javascript:void(0)' onclick='loadContent(\"div_container\", \"" . url_for("course/view?id=") . $record["id"] . "\")'><span class='glyphicon glyphicon-list'></span> View</a></td>";
            echo "</tr>";
        }
        ?>
    </tbody>
...
<script>
    $(document).ready(function () {
        $("#table_list_<?php echo $type; ?>").DataTable();
    });
</script>